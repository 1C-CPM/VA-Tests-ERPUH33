...
Сценарий: 04.06. [ЗАПРОС КОТИРОВОК] Договор ДД1
	...
	* Заполняем договор
		...
		Тогда таблица 'Номенклатура' стала равной:
			...
			| 'МестоПоставки1'  | '1 000,00' | 'РОССИЯ'               | 'т'                 | 'Материал1'    | 'Королевство Севера [223]' | 'РОССИЯ'               | '22%'        | 'Проект1' | '100 000,00' | '16 666,67' | 'XXX1'        | '100,000'    | 
			| 'МестоПоставки1'  | '1 200,00' | 'РОССИЯ'               | 'т'                 | 'Материал2'    | 'Королевство Севера [223]' | 'РОССИЯ'               | '22%'        | 'Проект1' | '300 000,00' | '50 000,00' | 'XXX1'        | '250,000'    | 
