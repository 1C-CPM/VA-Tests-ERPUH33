...
Сценарий: 07.03. [План закупок -> ЗАКАЗ; Королевство Скал] Заказ поставщику
	...
	* Подбор из плана закупок
		...
		* Товар 2		
		И в таблице 'СписокПотребностей' я перехожу к строке:
			| "Дата поставки" | "Единица измерения" | "Количество" | "Место поставки" | "Номенклатура" | "Организация заказчик"     | "Сумма"     | "Цена"     | "ЦФО потребитель"               |
			| "31.01.2025"    | "упак"              | "5,000"      | "МестоПоставки2" | "Товар2"       | "Королевство Севера [223]" | "42 500,00" | "8 500,00" | "ЦФО1 Королевство Севера [223]" |
		И в таблице 'СписокПотребностей' я выбираю текущую строку
	...
	* Закрываем все окна
		...
		Тогда открылось окно 'Заказы поставщикам'
		И я закрыл окно 'Заказы поставщикам'
...
//		И в таблице 'СписокПотребностей' я перехожу к строке:
//			| "Дата поставки" | "Единица измерения" | "Количество" | "Место поставки" | "Номенклатура" | "Организация заказчик"     | "Сумма"        | "Цена"       | "ЦФО потребитель"               |
//			| "31.01.2025"    | "шт"                | "3,000"      | "МестоПоставки1" | "Товар1"       | "Королевство Севера [223]" | "1 019 800,00" | "101 980,00" | "ЦФО1 Королевство Севера [223]" |
//		И в таблице 'СписокПотребностей' я выбираю текущую строку
//
//		И в таблице 'СписокПотребностей' я перехожу к строке:
//			| "Дата поставки" | "Единица измерения" | "Количество" | "Место поставки" | "Номенклатура" | "Организация заказчик"     | "Сумма"        | "Цена"       | "ЦФО потребитель"               |
//			| "28.02.2025"    | "шт"                | "5,000"      | "МестоПоставки2" | "Товар2"       | "Королевство Севера [223]" | "1 019 800,00" | "101 980,00" | "ЦФО1 Королевство Севера [223]" |
//		И в таблице 'СписокПотребностей' я выбираю текущую строку
//		
//		И я нажимаю на кнопку с именем 'ФормаОтправитьИЗакрыть'
