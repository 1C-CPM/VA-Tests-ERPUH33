...
Сценарий: 07.01.03 [План закупок - Заказ поставщику, Королевство Севера] Заказ поставщику
	...
	* Проверяем ТЧ
		...
		Тогда таблица 'Товары' стала равной:
			| 'Упаковка' | 'Цена'      | 'Номенклатура' | 'Склад'  | 'Сумма с НДС' | 'Ставка НДС' | 'НДС'      | 'Потребитель (ЦФО)'             | 'Место поставки' | 'Количество' | 'Статьи и аналитики'                                                                     | 'Сумма'     |
			| 'кг'       | '10 000,00' | 'Товар1'       | 'Склад1' | '30 000'      | '22%'        | '5 409,84' | 'ЦФО1 Королевство Севера [223]' | 'МестоПоставки1' | '3,000'      | 'Статья БДР 1;XXX1;YYY1;ZZZ1;SSS1;RRR1;WWW1;Статья БДДС 1;AAA1;BBB1;CCC1;DDD1;EEE1;FFF1' | '30 000,00' |
			| 'упак'     | '8 500,00'  | 'Товар2'       | 'Склад1' | '42 500'      | '22%'        | '7 663,93' | 'ЦФО1 Королевство Севера [223]' | 'МестоПоставки1' | '5,000'      | 'Статья БДР 1;XXX1;YYY1;ZZZ1;SSS1;RRR1;WWW1;Статья БДДС 1;AAA1;BBB1;CCC1;DDD1;EEE1;FFF1' | '42 500,00' |
