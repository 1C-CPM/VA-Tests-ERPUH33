...
Сценарий: 01.10.1 Организационная структура
	* Создаюм ЮЛ
		...
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			И Я для организации 'ВА - ООО Тест' создаю банковский счет '044525630' '40700810000000000011' 
			И Я для организации 'ВА - ООО Тест' создаю банковский счет '044525630' '40701840145250000973'
			И Я для организации 'ВА - ООО Тест' создаю банковский счет '044525630' '40701978100000000014'		
	* Создаем ЦФО	
...
Сценарий: 01.10.2 Банковские счета внутригрупповых контрагентов
...
Сценарий: 01.12 Контрагенты
	...
	ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда	
		...
		И Я для контрагента с именем 'ВА - Поставщик1' указываю ИНН '7714774531' и КПП '649701844' 
		И Я для контрагента с именем 'ВА - Поставщик1' создаю банковский счет '044525630' '40701810200010000027' 
		И Я для контрагента с именем 'ВА - Поставщик1' создаю банковский счет '044525630' '40701840000000000016'
		И Я для контрагента с именем 'ВА - Поставщик1' создаю банковский счет '044525630' '40701978000000000027'
...
Сценарий: 01.13 Номенклатура
	...
	Если '$$ЭтоЕРПУХ$$' Тогда
		И Я для номенклатуры с именем 'ВА - Товар1' для реквизита 'КодОКПД2' выбираю значение '41.10.1' в группе 'СворачиваемаяГруппаКлассификаторы'
		И Я для номенклатуры с именем 'ВА - Товар2' для реквизита 'КодОКПД2' выбираю значение '41.10.1' в группе 'СворачиваемаяГруппаКлассификаторы'
		И Я для номенклатуры с именем 'ВА - Товар3' для реквизита 'КодОКПД2' выбираю значение '41.10.1' в группе 'СворачиваемаяГруппаКлассификаторы'
