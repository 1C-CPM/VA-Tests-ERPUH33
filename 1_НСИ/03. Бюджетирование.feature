...
Сценарий: 00.04 Создание пользователей
	...
	И Я нахожу или создаю пользователя "Администратор" группа доступа "Администраторы" группа "" почта "Admin1@mail.ru"	

	И Я нахожу или создаю группу пользователей с именем "ВА - Бюджетирование"

	И Я нахожу или создаю пользователя "Бюджетирование1" группа доступа "ВА - Бюджетирование (Редактирование)" группа "ВА - Бюджетирование" почта "Budget1@mail.ru"
	И Я нахожу или создаю пользователя "Бюджетирование2" группа доступа "ВА - Бюджетирование (Редактирование)" группа "ВА - Бюджетирование" почта "Budget2@mail.ru"
	И Я нахожу или создаю пользователя "Бюджетирование3" группа доступа "ВА - Бюджетирование (Просмотр)" группа "ВА - Бюджетирование" почта "budget3@mail.ru"
	И Я нахожу или создаю пользователя "Бюджетирование4" группа доступа "ВА - Бюджетирование (Просмотр)" группа "ВА - Бюджетирование" почта "budget4@mail.ru"
	...
	Если '$$ЭтоЕРПУХ$$' Тогда	
		...
		* Вводим документ за Февраль
			...
			И в таблице 'КомпоновщикНастроекНастройкиОтбор' я перехожу к строке:
				...
				| 'В списке'      | ''         | 'Нет'           | 'Вид номенклатуры' | 'Обычное'    | 'Быстрый доступ'    |
			...
			* Запишем документ, проверим движения
				...
				Если '$$ЭтоЕРПУХ$$' Тогда
					Тогда таблица "ОперацииБюджетов" стала равной:
						| 'N' | 'Вид бюджета'                      | 'Приход расход' | 'Сумма' | 'Аналитика партнеров'                                    | 'Курс планирования' | 'Сумма исполнено' | 'Аналитика структуры'                              | 'Валюта' | 'Аналитика статей бюджетов'               |
