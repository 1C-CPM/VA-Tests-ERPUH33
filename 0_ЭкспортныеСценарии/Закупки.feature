...
Сценарий: Я добавляю Номенклатуру в ТЧ ="ТекТЧ", Номенклатура = "ТекНоменклатура", ЦФО = "ТекЦФО", МестоПоставки = "ТекМестоПоставки", ДатаПоставки = "ТекДатаПоставки", Колво = "ТекКолво", Цена = "ТекЦена", СтавкаНДС = "ТекСтавкаНДС", Проект = "ТекПроект"
...
//		Тогда открылось окно 'Номенклатура'
	...
	* ЦФО
		...
		И я перехожу к следующему реквизиту
		//И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем "ЦФО" //ух33
...
//		И я перехожу к следующему реквизиту
	...
	* Ставка НДС
		...
		И в таблице '[ТекТЧ]' из выпадающего списка с именем 'НоменклатураСтавкаНДС' я выбираю точное значение '[ТекСтавкаНДС]'
		И я перехожу к следующему реквизиту
