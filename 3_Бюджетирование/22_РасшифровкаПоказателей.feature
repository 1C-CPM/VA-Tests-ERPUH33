...
Сценарий: 22.08 Проверка расшифровки доп. валют для вида отчета по счетам МСФО
	...
	Если '$$ЭтоЕРПУХ$$' Тогда
		...
		* Счет 1.3.00.00.00
			И в поле с именем 'Код' я ввожу текст "1.3.00.00.00"
			И в поле с именем 'Наименование' я ввожу текст "Краткосрочная дебиторская задолженность"
			И в поле с именем 'КодБыстрогоВыбора' я ввожу текст "13000000"
		...
		* Счет 1.3.01.00.00
			И в таблице 'ПланСчетов' я нажимаю на кнопку с именем 'ПланСчетовСоздать'
			Тогда открылось окно "Счет МСФО (создание)"
			И в поле с именем 'Код' я ввожу текст "1.3.01.00.00"
			И в поле с именем 'Наименование' я ввожу текст "Краткосрочная дебиторская задолженность покупателей и заказчиков"
			И в поле с именем 'КодБыстрогоВыбора' я ввожу текст "13010000"
			И из выпадающего списка с именем 'Вид' я выбираю точное значение "Активный"
		...
		* Счет 1.3.01.62.01
			И в таблице 'ПланСчетов' я нажимаю на кнопку с именем 'ПланСчетовСоздать'
			Тогда открылось окно "Счет МСФО (создание)"
			И в поле с именем 'Код' я ввожу текст "1.3.01.62.01"
			И в поле с именем 'Наименование' я ввожу текст "Краткосрочная дебиторская задолженность покупателей и заказчиков"
			И в поле с именем 'КодБыстрогоВыбора' я ввожу текст "13016201"
			И из выпадающего списка с именем 'Вид' я выбираю точное значение "Активный"
			И я нажимаю кнопку выбора у поля с именем 'Родитель'
			Тогда открылось окно "План счетов МСФО"
			И в таблице 'Список' я перехожу к строке:
		...
		* Счет 1.3.01.62.04
			И в таблице 'ПланСчетов' я нажимаю на кнопку с именем 'ПланСчетовСоздать'
			Тогда открылось окно "Счет МСФО (создание)"
			И в поле с именем 'Код' я ввожу текст "1.3.01.62.04"
			И в поле с именем 'Наименование' я ввожу текст "Краткосрочная дебиторская задолженность покупателей и заказчиков - обесценение"
			И в поле с именем 'КодБыстрогоВыбора' я ввожу текст "13016204"
			И из выпадающего списка с именем 'Вид' я выбираю точное значение "Активный"
			И я нажимаю кнопку выбора у поля с именем 'Родитель'
			Тогда открылось окно "План счетов МСФО"
			И в таблице 'Список' я перехожу к строке:
		...
		* Счет 1.1.01.50.03
			И в таблице 'ПланСчетов' я нажимаю на кнопку с именем 'ПланСчетовСоздать'
			Тогда открылось окно "Счет МСФО (создание)"
			И в поле с именем 'Код' я ввожу текст "1.1.01.50.03"
			И в поле с именем 'Наименование' я ввожу текст "Денежные документы"
			И в поле с именем 'КодБыстрогоВыбора' я ввожу текст "11015003"
			И из выпадающего списка с именем 'Вид' я выбираю точное значение "Активный"
			И я нажимаю кнопку выбора у поля с именем 'Раздел'
			Тогда открылось окно "Категории счетов"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование"                               |
				| "Прочие активы/обязательства - BS Other A/L" |
			И я нажимаю на кнопку с именем 'ФормаВыбрать'
			Тогда открылось окно "Счет МСФО (создание) *"
			И в таблице 'ВидыСубконто' я нажимаю на кнопку с именем 'ВидыСубконтоДобавить'
			И в таблице 'ВидыСубконто' я нажимаю кнопку выбора у реквизита с именем 'ВидыСубконтоВидСубконто'
	...
	* Задаем учетную политику МСФО для организации
		...
		Иначе
			...
			И в таблице 'Список' я перехожу к строке:
				...
				| "Меркурий ООО" |
		И в таблице 'Список' я выбираю текущую строку
		Когда открылось окно "Меркурий ООО (Организаци*)"
		Если '$$ЭтоУХ$$' Тогда
